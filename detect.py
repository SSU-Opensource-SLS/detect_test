...
# YOLOv5 🚀 by Ultralytics, AGPL-3.0 license0
"""
...
Usage - formats:
    $ python detect.py --weights yolov5s.pt                 # PyTorch
                                 ...
                                 yolov5s.mlmodel            # :5000reML (macOS-only)
...
def run(
        weights=ROOT / 'SLMS_Opensource.pt',  # model path or triton URL
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'SLMS_Opensource.pt', help='model path or triton URL')
